...
from sprite import astroids
import random

class Game():
    def __init__(self, screen, astroids_count, star_count, bg_image):
        ...
        self.key_pressed = 0
        self.astroid_pos = ((random.randrange(50, 1000)), (random.randrange(10, 900)))
        self.surf = screen
        ...
        self.bg_img = pg.image.load(bg_image).convert()
        ...
        for i in range(int(astroids_count)):
            self.astroid = astroids(self.astroid_pos)            
            self.astroid_pos = ((random.randrange(0, 1000)), (random.randrange(0, 900)))
            #Add Block to sprite list
            self.block_list.add(self.astroid)
            self.all_sprite_list.add(self.astroid)
